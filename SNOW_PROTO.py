...
def SNOW():
    ...
    TOKEN='Uf6F9om9sP4NQGXQ59kz0Lln74JjDwU4SpLXlwxBcyJ'
    ...
    for (url,Key) in elements:
        ...
        try:
            ...
            imagefile.save(imagefile, quality=95)
            


        except:
            filename=r'C:\Users\mizun\OneDrive\MyPythonProject\image_folder\WE_HAVE_NO_IMAGE.png'
